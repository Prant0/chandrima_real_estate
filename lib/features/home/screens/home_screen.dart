              ...
              child: Column(children: [
                Row(children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text('John Doe', style: poppinsMedium.copyWith(fontSize: Dimensions.fontSizeSixteen, color: AppColors.white)),
                      Text('ID: 1243', style: poppinsRegular.copyWith(color: AppColors.white)),
                    ],
                  ),
                  const Spacer(),
