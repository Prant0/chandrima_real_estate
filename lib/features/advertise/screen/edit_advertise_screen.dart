...
class EditAdvertiseScreen extends StatefulWidget {
    EditAdvertiseScreen({super.key,required this.advertiseModel});
  MyAdvertiseModel advertiseModel;

  @override
  State<EditAdvertiseScreen> createState() => _EditAdvertiseScreenState();
}

class _EditAdvertiseScreenState extends State<EditAdvertiseScreen> {
  ...
  void initState() {
    ...
    _titleController.text= widget.advertiseModel.title!;
    _descriptionController.text= widget.advertiseModel.description!;
    mediaValue= widget.advertiseModel.adType;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(title: 'Edit Advertise'),
                        ...
                        child: Stack(
                            children: [
                              homeController.pickedFile != null ? GetPlatform.isWeb ? Image.network(
                                  widget.advertiseModel.image.toString(), width: 80, height: 80, fit: BoxFit.cover) : Image.file(
                                  File(homeController.pickedFile!.path), width: 80, height: 80, fit: BoxFit.cover) :   CustomNetworkImage(
                                image: '${widget.advertiseModel.image}',
                  ...
                  CustomCard(
                    ...
                    child: CustomButton(
                      ...
                      onPressed: () {
                        ...
                        mediaValue=="image"? homeController.updateAdvertise(
